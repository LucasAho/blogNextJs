    ...
    <div className={styles.container}>
      ...
      <Container>
          ...
          <h6>
            ...
            Feel free to <Link href="/contact" as="/contact" className="decorated-link"><a>contact me</a></Link> (note that contact form has been a wee bit buggy, so if I don't get back to you, try connecting via my socials)
          </h6>
          <Row>
